...
module.exports = {
  config: {
    ...
    categorie: "AI Chat",
    cooldowns: 5,
    credit: "Developed by Mohammad 𝐫𝐚𝐡𝐢",
    usages: [
  ...
  start: async function ({ api, event, args }) {
    ...
    if (!usermsg) {
      const greetings = [
  "আহ শুনা আমার  জিহাদ বস এ তোমার অলিতে গলিতে উম্মাহ দের 😇😘",
  "কি গো সোনা আমাকে ডাকছ কেনো আমাকে না ডাকে আমার বস জিহাদ কে ডাক ",
  "বার বার আমাকে ডাকস কেন😡",
  "আহ শোনা আমার আমাকে এতো ডাক্তাছো কেনো আসো বুকে আশো🥱",
  "হুম জান তোমার অইখানে  জিহাদ বস এ উম্মমাহ দের 😷😘",
  "আসসালামু আলাইকুম বলেন আপনার জন্য কি করতে পারি",
  "আমাকে এতো না ডেকে বস জিহাদকে একটা জিএফ দে 🙄",
